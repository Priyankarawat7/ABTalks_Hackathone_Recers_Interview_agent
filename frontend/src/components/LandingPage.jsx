          ...
          <div>
            <section className="pt-12 pb-16 text-center relative">
              ...
              <p className="mt-6 text-slate-400 text-base sm:text-lg max-w-3xl mx-auto leading-relaxed">
                ...
                (MCP), and Kubernetes. Evaluated by adaptive AI interview
                agents!
              </p>
            ...
            <section className="py-16 border-t border-slate-800/80">
              <div className="text-center mb-12">
                ...
                <p className="text-slate-400 text-sm mt-3 max-w-2xl mx-auto">
                  Get guidance across Generative AI, RAG, Agentic Systems, MCP
...
<section className="py-20 border-t border-slate-800/80 relative overflow-hidden">
  ...
  <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-6 relative z-10">
    ...
    <div className="
      bg-gradient-to-br from-slate-950 via-slate-850 to-black
                    ...
                    <div className="mt-10 space-y-7">
                      <div className="flex gap-4 items-start">
                        ...
                        <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                          Build and showcase real AI projects and gain hands-on
                          experience by completing the 31-day AI engineering
                          cohort.
                        </p>
                      </div>
                      ...
                      <div className="flex gap-4 items-start">
                        ...
                        <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                          Complete AI-powered technical assessments and receive
                          detailed feedback based on your learning journey.
                        </p>
                      </div>
                      ...
                      <div className="flex gap-4 items-start">
                        ...
                        <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                          ...
                          of the cohort and interview assessment.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative w-full max-w-[540px] aspect-[1.42/1] bg-white rounded-xl shadow-2xl overflow-hidden border border-slate-300">
                      ...
                      <div className="h-full flex flex-col justify-center px-14 sm:px-20">
                        ...
                        <h4 className="text-lg sm:text-2xl font-black text-slate-800 leading-tight">
                          AI-DRIVEN{" "}
                          <span className="text-indigo-900">GENERATIVE AI</span>
                        ...
                        <p className="text-[6px] sm:text-[8px] text-slate-500 leading-relaxed mt-4 max-w-md">
                          Awarded for the successful completion of the ABTalks
                          31-Day AI Cohort and AI Interview Assessment. This
                          certificate validates practical knowledge of modern
                          Generative AI engineering, RAG, Agentic AI, MCP and
                          production systems.
                        </p>
...
===================================================== */}
    ...
    "
          ...
          `}
              ...
              ${isOpen ? "opacity-100 scale-150" : "opacity-0 scale-75"}
            `}
                      />
          ...
          <div className="mt-12 max-w-5xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-slate-400 text-sm mt-2 max-w-xl mx-auto">
                ...
                workflows trained during the 31-day cohort.
              </p>
            </div>
